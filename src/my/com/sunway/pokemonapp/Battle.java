        ...
        while (!battleEnded) {
            ...
            if (attacker == userPokemon1 || attacker == userPokemon2) {
                ...
                if (reactionTime1 != -1) {
                    ...
                    print(attacker.getName() + " attacks! Attack: " + (attackStrength1 + specialAttackStrength1) + ", HP: " + attacker.getHealth());
                    ...
                    print(attacker.getName() + " attacks! Attack: " + (attackStrength2 + specialAttackStrength2) + ", HP: " + attacker.getHealth());
            ...
            if (wildPokemon1.getHealth() <= 0 && wildPokemon2.getHealth() <= 0) {
                System.out.println("\r\n"
                		+ " __     ______  _    _  __          ______  _   _   _______ _    _ ______   ____       _______ _______ _      ______ _ \r\n"
                		+ " \\ \\   / / __ \\| |  | | \\ \\        / / __ \\| \\ | | |__   __| |  | |  ____| |  _ \\   /\\|__   __|__   __| |    |  ____| |\r\n"
                		+ "  \\ \\_/ / |  | | |  | |  \\ \\  /\\  / / |  | |  \\| |    | |  | |__| | |__    | |_) | /  \\  | |     | |  | |    | |__  | |\r\n"
                		+ "   \\   /| |  | | |  | |   \\ \\/  \\/ /| |  | | . ` |    | |  |  __  |  __|   |  _ < / /\\ \\ | |     | |  | |    |  __| | |\r\n"
                		+ "    | | | |__| | |__| |    \\  /\\  / | |__| | |\\  |    | |  | |  | | |____  | |_) / ____ \\| |     | |  | |____| |____|_|\r\n"
                		+ "    |_|  \\____/ \\____/      \\/  \\/   \\____/|_| \\_|    |_|  |_|  |_|______| |____/_/    \\_\\_|     |_|  |______|______(_)\r\n"
                		+ "                                                                                                                       \r\n"
                		+ "                                                                                                                       \r\n"
                		+ "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣴⡇⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\r\n"
                		+ "⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣾⣿⡇⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\r\n"
            ...
            if (userPokemon1.getHealth() <= 0 && userPokemon2.getHealth() <= 0) {
                System.out.println("\r\n"
                		+ " __     ______  _    _   _      ____   _____ _______   _______ _    _ ______   ____       _______ _______ _      ______ _ \r\n"
                		+ " \\ \\   / / __ \\| |  | | | |    / __ \\ / ____|__   __| |__   __| |  | |  ____| |  _ \\   /\\|__   __|__   __| |    |  ____| |\r\n"
                		+ "  \\ \\_/ / |  | | |  | | | |   | |  | | (___    | |       | |  | |__| | |__    | |_) | /  \\  | |     | |  | |    | |__  | |\r\n"
                		+ "   \\   /| |  | | |  | | | |   | |  | |\\___ \\   | |       | |  |  __  |  __|   |  _ < / /\\ \\ | |     | |  | |    |  __| | |\r\n"
                		+ "    | | | |__| | |__| | | |___| |__| |____) |  | |       | |  | |  | | |____  | |_) / ____ \\| |     | |  | |____| |____|_|\r\n"
                		+ "    |_|  \\____/ \\____/  |______\\____/|_____/   |_|       |_|  |_|  |_|______| |____/_/    \\_\\_|     |_|  |______|______(_)\r\n"
                		+ "                                                                                                                          \r\n"
                		+ "                                                                                                                          \r\n"
                		+ "⠀⠀⠀⠀⠀⢸⠓⢄⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\r\n"
                		+ "⠀⠀⠀⠀⠀⢸⠀⠀⠑⢤⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\r\n"
